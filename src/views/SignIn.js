...
const useStyles = makeStyles((theme) => ({
    ...
    image: {
        backgroundImage: 'url(https://images.unsplash.com/photo-1568084680786-a84f91d1153c?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1074&q=80)',
        ...
        <div>
            <Grid container component="main"  className={classes.root}>
                ...
                <Grid item xs={false} sm={4} md={8} className={classes.image} >
                    <div className="signup-MainTitle"onClick={()=>{history.push("/")}} > Hotel <text style={{ color: "green" }}>Lemon</text> Tree </div>
                    </Grid>
