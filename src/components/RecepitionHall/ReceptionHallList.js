...
export const RecepitonHallList = () => {
  return (
    <div>
      ...
      <Title
        className="PicTitileRoomReserve"
        title="Reserve a Reception Hall"
      />
          ...
          <Card style={{ width: "70%", margin: "20px" }}>
            ...
            <Card.Body id="repcard-body">
              ...
              <Card.Text className="repDesc">
                Upholding its reputation to the name, the grandest venue at
                waters edge is located on the 3rd floor, with a panoramic view
                of the lake and beyond. The unique column free feature ensures
                the largest seating capacity for a minimum of 500 guests.{" "}
              </Card.Text>
              ...
              <div className="repFlex">
                ...
                <List component="nav" aria-label="secondary mailbox folders">
                  <div>
                    ...
                    <ListItemIcon>
                      <RoomRoundedIcon style={{ color: "#827c74" }} />
                      <div className="repList">Location</div>
                    </ListItemIcon>
                    <div className="repListChild">
                      Lobby level with lawn views
                    </div>

                    <hr className="repListHR" />

                    <ListItemIcon>
                      <GroupRoundedIcon style={{ color: "#827c74" }} />
                      <div className="repList">Occupancy</div>
                    </ListItemIcon>
                    <div className="repListChild">
                      Capacity for 500 guests (seated)
                    </div>

                    <hr className="repListHR" />

                    <ListItemIcon>
                      <SquareFootRoundedIcon style={{ color: "#827c74" }} />
                      <div className="repList">Area</div>
                    </ListItemIcon>
                    <div className="repListChild">
                      676 m2 or 7725 sq. ft. floor space
                    </div>
                  ...
                  <List component="nav" aria-label="main mailbox folders">
                    <ListItemIcon>
                      <ChevronRightOutlinedIcon
                        style={{ color: "#0e992e", marginTop: "5px" }}
                      />
                    ...
                    <ListItemIcon>
                      <ChevronRightOutlinedIcon
                        style={{ color: "#0e992e", marginTop: "5px" }}
                      />
                      Unobstructed view from any angle
                    </ListItemIcon>
        ...
        <div className="repCard">
          <Card style={{ width: "70%", margin: "20px" }}>
            ...
            <Card.Body id="repcard-body">
              ...
              <Card.Text className="repDesc">
                The Grand Banquet Hall is the largest hall in Brighten Hotels.
                The hall is ideal for weddings, birthday parties, engagements,
                receptions, corporate events etc.{" "}
              </Card.Text>
              ...
              <div className="repFlex">
                ...
                <List component="nav" aria-label="secondary mailbox folders">
                  <div>
                    ...
                    <div className="repListChild">
                      Capacity for 400 guests (seated)
                    </div>
                    ...
                    <div className="repListChild">
                      600 m2 or 7425 sq. ft. floor space
                    </div>
        ...
        <div className="repCard">
          <Card style={{ width: "70%", margin: "20px" }}>
            ...
            <Card.Body id="repcard-body">
              ...
              <Card.Text className="repDesc">
                Sangeeth Hall is designed to meet relatively smaller gatherings
                such as birthdays, engagements, baby showers, small scale
