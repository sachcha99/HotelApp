    ...
    <div>
      <Snackbar open={open} autoHideDuration={3000} onClose={handleCloseSnack}>
        <Alert onClose={handleCloseSnack} severity="success">
          {row
            ? `Reception Hall Reservation Successfully Updated `
      ...
      <div className="repBtn">
        {row ? (
          <Button className=" conf-btn2" variant="primary" onClick={handleShow}>
            <EditOutlinedIcon fontSize="small" /> Edit
          </Button>
        ) : (
          <Button variant="primary" className="repBtn1" onClick={handleShow}>
            Make an Enquiry
          </Button>
        )}
      </div>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
            {row
              ? `Update Reception Hall Reservation Details`
              : `Check Availability of the Reception Hall`}
          </Modal.Title>
        </Modal.Header>
        <form onSubmit={handleSubmit}>
                ...
                <Grid item>
                  <div className={classes.margin}>
                    <Grid container spacing={1} alignItems="flex-end">
                      ...
                      <Grid item>
                        <label className={classes.textFieldLabel1}>
                    ...
                    <Grid container spacing={1} alignItems="flex-start">
                      ...
                      <Grid item>
                        <FormControl component="fieldset">
                          <FormLabel
                            className={classes.textFieldLabel2}
                            component="legend"
                          >
                            Menu Selection
                          </FormLabel>
                          ...
                          >
                            <FormControlLabel
                              value="MenuA"
                              control={
                                <Radio required={true} color="primary" />
                              }
                              label="Menu A"
                            />
                            <FormControlLabel
          ...
          <Modal.Footer>
            ...
            <Button type="submit" className="bookingBtn" variant="primary">
              {row ? `Update` : `Reserve`}
            </Button>
          </Modal.Footer>
        </form>
