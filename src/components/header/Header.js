...
const Header = (props) => {
  ...
  return (
    <div>
      <Navbar
        className={navbar ? "navBarr1" : "navBarr"}
        fixed="top"
        light
        expand="md"
      >
        ...
        <Collapse className="navCollaspe" isOpen={isOpen} navbar>
          <Nav className="mr-auto" navbar>
            <NavItem>
              <NavLink className="navItem" onClick={goToHome}>
                Home
              </NavLink>
            </NavItem>
            <NavItem>
              <NavLink className="navItem" onClick={goToRooms}>
                Accommodation
              </NavLink>
            </NavItem>
            <NavItem>
              <NavLink className="navItem" onClick={goToReceptionHalls}>
                Wedding & Event
              </NavLink>
            </NavItem>
            <NavItem>
              <NavLink className="navItem" onClick={goToRestaurant}>
                Restaurant
              </NavLink>
            </NavItem>
            <NavItem>
              <NavLink className="navItem" onClick={GotoAbout}>
                About
              </NavLink>
            </NavItem>
          </Nav>
          {!token ? (
            ...
            >
              ...
              <DropdownMenu>
                ...
                <DropdownItem onClick={goToLogOut}>Logout</DropdownItem>
              </DropdownMenu>
            </UncontrolledButtonDropdown>
          ) : (
            <UncontrolledButtonDropdown
            ...
            >
              ...
              <DropdownMenu>
                <DropdownItem onClick={goToAdmin}>Admin Dashboard</DropdownItem>
                <DropdownItem onClick={goToLogOut}>Logout</DropdownItem>
              </DropdownMenu>
            </UncontrolledButtonDropdown>
          )}
