      ...
      {IsProgress ? (
        ...
        <div>
          <Title
            ...
            title="Room Reservation History"
          />
          ...
          <div id="admin-card-back">
            ...
            <div>
              {!count == 0 ? (
                <div className="CountingHeadUser">
                  {" "}
                  {StatusFilter} Room Reservations ({count})
                </div>
              ) : (
                <div className="ZeroCountingHeadUser">
                  {" "}
                  No Any Room Reservations
                </div>
              )}
              {rows.length > 0 &&
                rows.map((row) => {
                    ...
                    return (
                      <div className="cardBack" key={row._id}>
                        <Card className="text-center">
                          <Card.Header>
                            Booking No - RM{row._id.substring(0, 7)}
                          </Card.Header>
                          <Card.Body>
                                ...
                                <div className="card-his-bodyFlex">
                                  <div>
                                    <h6 className="card-his-body">
                                      <HouseIcon id="card-his-bodyIcon" />
                                      No of Rooms: {row.roomNo}
                                    </h6>
                                    <h6 className="card-his-body">
                                      <EmojiPeopleIcon id="card-his-bodyIcon" />
                                      No of Adults : {row.adultNo}
                                    </h6>
                                    <h6 className="card-his-body">
                                      <ChildCareIcon id="card-his-bodyIcon" />
                                      No of Childs : {row.childNo}
                                    </h6>

                                    <h6 className="card-his-body">
                                      <LocalActivityIcon id="card-his-bodyIcon" />
                                      Customer Type :{" "}
                                      {row.loyalty === false
                                        ? "Loyalty"
                                        : "Regular"}
