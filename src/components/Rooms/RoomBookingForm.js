    ...
    <div>
      <Snackbar open={open} autoHideDuration={3000} onClose={handleCloseSnack}>
        <Alert onClose={handleCloseSnack} severity="success">
          {row
            ? "Room Reservation Successful Updated"
      ...
      {row ? (
        ...
        <Button variant="primary" className="roomBtn1" onClick={handleShow}>
          Reserve
        </Button>
      )}
      <Modal
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
            {row ? `Update Room Reservation` : `Reserve a room`}
          </Modal.Title>
        </Modal.Header>
        <form onSubmit={handleSubmit}>
          <Modal.Body>
            <div>
              <label className={classes.textFieldLabel3}>Capacity</label>
              <br></br>
            ...
            <div className={classes.margin}>
              <Grid container spacing={1} alignItems="flex-start">
                ...
                <Grid item>
                  <label className={classes.textFieldLabel4}>
                    Loyality Member
                  </label>
                  <Switch
