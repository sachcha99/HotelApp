            ...
            <div className="roomFlex">
              ...
              <Card.Body>
                ...
                <Card.Text className="roomDesc">
                  In the buzzing beachside, resort amenities of the cosiest kind
                  are yours at our deluxe rooms with all the comforts you need.
                  Bold colours paint bright cheer in the décor reflecting the
                  vibrant surrounds.
                </Card.Text>
                <ListItemIcon>
                  <SquareFootRoundedIcon
                    style={{ color: "#454c61", marginLeft: "20px" }}
                  />
                  <div className="roomIconList">35 Sq Mt</div>
                </ListItemIcon>
                <ListItemIcon>
                  <WifiRoundedIcon
                    style={{ color: "#454c61", marginLeft: "20px" }}
                  />
                  <div className="roomIconList">Complimentary WiFi</div>
                </ListItemIcon>
                <br></br>
                <ListItemIcon>
                  <KingBedRoundedIcon
                    style={{ color: "#454c61", marginLeft: "20px" }}
                  />
                  <div className="roomIconList">Twin/Queen</div>
                </ListItemIcon>
                <ListItemIcon>
                  <SupervisorAccountRoundedIcon
                    style={{ color: "#454c61", marginLeft: "20px" }}
                  />
                  <div className="roomIconList">Up to 3 guests</div>
                </ListItemIcon>
                <br></br> <br></br>
                <div className="roomCostFlex">
                  <ListItemIcon>
                    <StarRateRoundedIcon
                      style={{ color: "#827700", marginLeft: "20px" }}
                    />{" "}
                    Uninterrupted view of the twinkling pool and city
                  </ListItemIcon>

                  <ListItemIcon className="roomCost">
                    <div style={{ color: "#0d0d0a", marginLeft: "15px" }}>
                      {" "}
                      LKR :15000.00{" "}
                    </div>
                  </ListItemIcon>
                ...
                <div className="roomBtn">
                  ...
                  <RoomBookingForm
                    roomType={"Luxury Room City View"}
                    imageName={rep1}
                  />
                </div>
              </Card.Body>
            ...
            <div className="roomFlex">
              ...
              <Card.Body>
                ...
                <div className="roomBtn">
                  ...
                  <RoomBookingForm
                    roomType={"Deluxe Room Ocean Facing"}
                    imageName={rep2}
                  />
                </div>
              </Card.Body>
          ...
          <Card style={{ width: "80%", margin: "20px" }}>
            <div className="roomFlex">
              ...
              <Card.Body>
                <div className="roomTitleFlex">
                  <Card.Title className="roomTitle">
                    Deluxe Bed Room Suite City View
                  </Card.Title>
                </div>
                <Card.Text className="roomDesc">
                  In the buzzing beachside, resort amenities of the cosiest kind
                ...
                <div className="roomBtn">
                  ...
                  <RoomBookingForm
                    roomType={"Deluxe Bed Room Suite City View"}
                    imageName={rep3}
                  />
                </div>
              </Card.Body>
          ...
          <Card style={{ width: "80%", margin: "20px" }}>
            <div className="roomFlex">
              ...
              <Card.Body>
                <div className="roomTitleFlex">
                  <Card.Title className="roomTitle">
                    Deluxe Bed Room Suite Ocean View
                  </Card.Title>
                </div>
                <Card.Text className="roomDesc">
                  In the buzzing beachside, resort amenities of the cosiest kind
                ...
                <div className="roomBtn">
                  ...
                  <RoomBookingForm
                    roomType={"Deluxe Bed Room Suite Ocean View"}
                    imageName={rep4}
                  />
                </div>
              </Card.Body>
